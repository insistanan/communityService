...
<div class="container">
    ...
    <div class="funcarea">
        ...
        <div class="uk-card uk-card-default" id="shanchuyonghu">
            ...
            <div class="uk-card-body">
                ...
                <form action="deleteUser.do">
                    ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" placeholder="根据id删除" id="id" class="uk-input uk-form-small uk-form-width-large" name="id">
                        <div class="uk-margin">
